This file is the baseline code for PetFinder.my - Pawpularity Contest--Predict the popularity of shelter pet photos

以上文件是PetFinder.my - Pawpularity Contest（宠物预测大赛）比赛的baseline代码
